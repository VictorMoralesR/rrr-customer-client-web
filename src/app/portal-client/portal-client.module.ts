...
@NgModule({
  declarations: [ClientLoginPageComponent, ClientHomePageComponent, ClientHeaderComponent, ClientChatListPageComponent, ClientConversationPageComponent, ClientPublicationsListPageComponent],
  imports: [
    CommonModule,
